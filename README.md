...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/slicer-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10756&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/slicer-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `slicer` can be installed with:

```
conda install slicer
```

It is possible to list all of the versions of `slicer` available on your platform with:
